...
| @ Mention | `@` followed by letters, numbers or underscores | `@cumrocket`, `@犬` | None |
...
All match types evaluate page text locally within your browser. Browsed content and matching results are never sent to the developer or any external party for recognition or processing; see [privacy and data handling](../README.md#privacy).
