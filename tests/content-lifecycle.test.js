...
function fixture() {
  ...
  const context = vm.createContext({ CaptionCollector: class { configure() {} dispose() {} }, AdSkipper: class { configure() {} dispose() {} }, wirePopups: () => ({ dispose() {} }), AutoNavigator: class { configure() {} dispose() {} }, window: {}, Scanner, document: {}, persistCountHistory() {}, chrome: { runtime: {
